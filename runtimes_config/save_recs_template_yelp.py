TEMPLATE_BPR = """experiment:
  ...
  models:
    external.BPRMF:
      ...
      lr: 0.0008117122579380812
      epochs: {epochs}
      factors: [ 64 ]
      batch_size: 1024
      l_w: 0.002140563566598524
      normalize: True
      seed: 123
      early_stopping:
        patience: 10
  ...
  models:
    external.DGCF:
      meta:
        ...
        restore: False
        write_best_iterations: True
      lr: [loguniform, -9.2103403719762, -4.6051701859881]
      epochs: {epochs}
      factors: [ 64 ]
      batch_size: 1024
      l_w_bpr: [loguniform, -13.815510558, -4.60517018599]
      l_w_ind: [loguniform, -13.815510558, -4.60517018599]
      n_layers: [choice, [2, 3]]
      intents: [choice, [2, 4]]
      normalize: True
      seed: 123
